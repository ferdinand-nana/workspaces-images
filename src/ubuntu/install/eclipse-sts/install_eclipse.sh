...
tar -xzf eclipse.tar.gz  --strip-components=1 -C /opt

ECLIPSE_ICON="/opt/sts-${STS4_VER}.RELEASE/plugins/$(ls /opt/sts-${STS4_VER}.RELEASE/plugins/ | grep -m 1 org.eclipse.platform_)/eclipse128.png"
